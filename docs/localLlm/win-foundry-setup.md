...
- 本ドキュメントは **Foundry Local 0.8.119.102** を対象としています。**0.10.3では、NPUで動作しない・本ドキュメント記載のコマンド体系が変更されている等の問題を確認しているため、必ず0.8.119.102を使用してください**
...
```powershell
foundry model qwen2.5-coder-7b
```
