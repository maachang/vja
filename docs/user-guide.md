...
10. [アプリイベント（起動・終了処理）](#10-アプリイベント起動終了処理)
11. [拡張ランタイム](#11-拡張ランタイム)
12. [クラウドインフラ設定](#12-クラウドインフラ設定)
13. [AI 接続設定](#13-ai-接続設定)
14. [プロジェクト情報の設定](#14-プロジェクト情報の設定)
15. [プロジェクトの実行](#15-プロジェクトの実行)
16. [コンパイル（実行ファイルの生成）](#16-コンパイル実行ファイルの生成)
