...
if (process.env.VJA_TEST_MODE === "1") {
    const testMethods = [
        ...
        "testTblAiGenerateSchema", "testValidAiGenerateRules", "testExtRtGenDoc", "testTextToYamlGenerate", "testManualRetryAiFix", "testFormDesignTextToYamlGenerate", "testYamlAiGenerate",
    ] as const;
