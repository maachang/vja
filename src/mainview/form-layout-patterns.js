    ...
    const FORM_LAYOUT_PATTERNS = [
        {
            ...
            label: "⬆⬇ 上:入力+ボタン / 下:表示",
            desc: "画面上部に入力エリアを横並びで複数配置し、その右側にボタンエリアを配置する。画面下部には表示エリアを画面幅いっぱいに配置する。",
            boxes: [
        ...
        },
        {
            ...
            label: "◀▶ 左:入力 / 右:表示",
            desc: "画面左側に入力エリアを縦に複数配置し、その下にボタンエリアを配置する。画面右側には表示エリアを縦幅いっぱいに配置する。",
            boxes: [
        ...
        },
        {
            ...
            label: "📥 縦並び入力 + 右下ボタン",
            desc: "画面上部から縦に入力エリアの行を複数並べる。画面下部の右寄せにボタンエリアを横並びで配置する。表示エリアは持たない構成。",
            boxes: [
        ...
        },
        {
            ...
            label: "🔲 中央:入力 + 下部中央ボタン",
            desc: "画面中央にコンパクトな表示・入力エリアを配置し、画面下部中央にボタンエリアを横並びで配置する、小さめの構成。",
            boxes: [
        ...
        },
        {
            ...
            label: "🔳 上部:複数表示 + 下部:表示",
            desc: "画面上部に表示エリアを複数横並びで配置する。画面下部には表示エリアを画面幅いっぱいに配置する。入力エリアは持たない構成。",
            boxes: [
        ...
        },
        {
            ...
            desc: "画面上部に入力エリアとボタンエリアを横並びで配置する。その下に表示エリアを複数横並びで配置し、画面下部には表示エリアを画面幅いっぱいに配置する。",
            boxes: [
